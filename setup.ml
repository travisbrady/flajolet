...
(* OASIS_START *)
(* DO NOT EDIT (digest: 109f9d17d6544795e4cc97b74a970c14) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_c_sources =
                        ["murmur3.c"; "murmur3.h"; "xxhash.h"; "stubs.c"];
                      bs_data_files = [];
                      bs_ccopt =
                        [
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "bench_hashing.ml"});
               Executable
                 ({
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "¹p\b\000\153¬òue/oÚ ([ª";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
