...
(* OASIS_START *)
(* DO NOT EDIT (digest: 5328e5d13b1870e8938b9de21b8eb257) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "test_hashing.ml"});
               Executable
                 ({
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\t%¿Ú&˚f÷\011ÛYy\019\132!€";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
