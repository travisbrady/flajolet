...
(* OASIS_START *)
(* DO NOT EDIT (digest: 7f58cf81c4b9d87f615fc36679644119) *)
(*
...
let setup_t =
  {
       ...
       [
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_hyperloglog", []))];
          ...
          ("test_histogram",
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_histogram", []))];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)]
              });
          ("test_sbitmap",
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_sbitmap", []))];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)]
              });
          ("test_loglogbeta",
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_loglogbeta", []))];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)]
              })
       ];
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/travisbrady/flajolet";
          bugreports = None;
          ...
          description =
            Some
              [
                 OASISText.Para
                   "Probabilistic data structures for OCaml (HyperLogLog, Bloom filter and more)"
              ];
          tags = [];
          categories = [];
          files_ab = [];
            ...
            [
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("farmhash", None);
                           FindlibPackage ("bitarray", None);
                   ...
                   },
                   {
                      ...
                      lib_pack = false;
                      lib_internal_modules = ["Const"];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "flajolet";
                      lib_findlib_directory = None;
                      lib_findlib_containers = []
                   });
               Executable
                 ({
                     cs_name = "test_recordinality";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "test_recordinality.ml"
                   });
               Executable
                 ({
                     cs_name = "test_histogram";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "test_histogram.ml"});
               Executable
                 ({
                     cs_name = "test_sbitmap";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "test_sbitmap.ml"});
               Executable
                 ({
                     cs_name = "test_bloom";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "test_bloom.ml"});
               Executable
                 ({
                     cs_name = "bench_bloom";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "bench_bloom.ml"});
               Executable
                 ({
                     cs_name = "sbitmap_stdin";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "sbitmap_stdin.ml"});
               Executable
                 ({
                     cs_name = "test_hyperloglog";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "test_hyperloglog.ml"
                   });
               Executable
                 ({
                     cs_name = "test_cmsketch";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "test_cmsketch.ml"});
               Executable
                 ({
                     cs_name = "test_minhash";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "test_minhash.ml"});
               Executable
                 ({
                     cs_name = "test_loglogbeta";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "test_loglogbeta.ml"});
               Test
                 ({
                     cs_name = "test_hll";
                     cs_data = PropList.Data.create ();
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "topk.ml"});
               Executable
                 ({
                     cs_name = "card";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "card.ml"});
               Executable
                 ({
                     cs_name = "destats";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "destats.ml"})
            ];
     ...
     oasis_version = "0.4.8";
     oasis_digest =
       Some "\150K\199\233\025\rs\197\169\165(\212\012\130\158\144";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
